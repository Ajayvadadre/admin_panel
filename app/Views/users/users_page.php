        ...
        <div class="col-md-12 py-3">
            <div class="header w-100 d-flex justify-content-between">
                ...
                <div class="right-div d-flex ">
                    ...
                    <button type="button" style="height:max-content; margin-right: 10px;" class="btn btn-info"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="ms-3">
                                                <a href="Process/<?php echo $user['id'] ?>"
                                                    class="fw-bold mb-1 text-dark"><?php echo $user['Firstname'] ?></a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="dropdown h-100 ml-3 mt-2">
                                            <button data-mdb-button-init data-mdb-ripple-init data-mdb-dropdown-init
                                                class=" bg-transparent p-0 border-0 dropdown-toggle" type="button"
                                                id="dropdownMenuButton" data-mdb-toggle="dropdown" style="color: #6c6c6c;"
                                                aria-expanded="false">
                                                <i class="fas fa-cog text-dark"></i>
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li><a class="dropdown-item"
                                                        href="/displayUpdateUsers/<?php echo $user['id'] ?>">Update</a></li>

                                                <li><a class="dropdown-item" style="cursor: pointer;"
                                                        onclick="if (confirm('Are you sure you want to delete this user?')) { location.replace('/DeleteUser/<?php echo $user['id'] ?>'); }">Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
                                    ...
                                    <div class="select mr-5 mt-2">
                                        ...
                                        <select class="js-example-basic-single" style="width: 90%;" name="state">
                                            ...
                                            foreach ($accesslevel as $role) { ?>
                                                <option value="<?php echo $role['id'] ?>"><?php echo $role['roles'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
