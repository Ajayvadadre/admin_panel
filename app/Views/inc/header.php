...
<head>
  ...
  <!-- <link
    ...
    /> -->
  <script src=<?php echo base_url('jquery/jquery2.js') ?>></script>
  <style>
    html {
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li>
                  <a
                    ...
                    href="/HourlyReport/<?= (getenv('HOURLY_URL')) ?> ">Hourly report</a>
                </li>
                ...
                <div class="dropdown">
                  ...
                  <ul
                    ...
                    <li>
                      <a class="dropdown-item" href="/Overallreport/elastic">Elastic</a>
                    </li>
                  </ul>
                </div>
              </ul>
          ...
          <li class="nav-item">
            <div class="dropdown h-100 ml-3 mt-2">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <li>
                <li><a class="dropdown-item" href="/userState">UserState</a></li>
                <li>
                  <a class="dropdown-item" href="/Campaigns">Campaigns</a>
                </li>
                <li>
                  <a class="dropdown-item" href="/Chatcontroller/ShowChat">Chat</a>
                </li>
              </ul>
            </div>
          </li>
